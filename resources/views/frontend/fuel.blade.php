    ...
    <div class="g-bg-secondary g-py-100 g-pt-170">
        <div class="container">
            ...
            <div class="text-uppercase g-mb-45 text-left">
                <h3 class="u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-mb-minus-10">Fuel</h3>
            </div>
            <!-- End Heading -->
            ...
            <div class="row">
                <div class="col-md-3">
                    <img src="{{ asset('assets/img/mro/fuel.jpg') }}" alt="Fuel" style="max-width: 270px;" title="Fuel">
                </div>
                <div class="col-md-9">
                    <p></p>
                </div>
